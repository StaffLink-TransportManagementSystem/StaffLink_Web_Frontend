            ...
            .then(data => {
                ...
                row += `<tr>
                        ...
                        <td class="Action">
                            ...
                            <a href="http://127.0.0.1:5501/Owner/editPassenger.html?email=`+ passenger.email +`" onclick="updatefunction(passenger.name,passenger.email,passenger.NIC)"><button class="edit">EDIT</button></a>
                            <a href="http://127.0.0.1:5501/Owner/deletePassenger.html?email=`+ passenger.email +`" onclick=""><button class="delete">DELETE</button></a>
                        </td>
                    </tr>`
                });
